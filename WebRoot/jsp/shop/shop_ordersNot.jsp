...
<div class="panel">
	<div class="panel-heading">
		...
		<h3 class="panel-title">未接的<s:if test="order_type==0">外卖订单</s:if>
				...
				<s:iterator value="shop.ordeers" var="order">
					<tr>
						...
						<td style="vertical-align: middle;"><button
								class="btn btn-primary" onclick="accessOrder(event,<s:property value="#order.customer.id"/>,<s:property value='#order.id'/>,1)">接单</button></td>
