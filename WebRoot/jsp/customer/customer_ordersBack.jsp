...
<div class="panel shadow">
	<div class="panel-heading">
		<h3 class="panel-title">退单:<s:if test="order_type==0">外卖订单</s:if>
			...
			<tbody id="orderTable">
				<s:iterator value="customer.orders" var="order">
					<tr>
						...
						<td style="vertical-align: middle;">
							<button class="btn btn-danger" onclick="updateOrderStatus(event,<s:property value='#order.id'/>,0)">取消退单</button>
						</td>
					</tr>
				</s:iterator>
			</tbody>
